...
<head>
    ...
    <!--===============================================================================================-->
    <link rel="icon" type="image/png" href="<?= base_url($config->icon) ?>"/>
    <!--===============================================================================================-->
    ...
    <!--===============================================================================================-->
    <link rel="stylesheet" href="<?= base_url('assets/front/') ?>vendor/noui/nouislider.min.css">
</head>
...
<header class="header1">
    ...
    <div class="container-menu-header">
        ...
        <div class="wrap_header">
            ...
            <a href="<?= base_url('/') ?>" class="logo">
                <img src="<?= base_url($config->logo) ?>" alt="<?= $config->title ?>">
            </a>
            ...
            <div class="wrap_menu">
                <nav class="menu">
                    <ul class="main_menu">
                        <li <?= $this->uri->segment(1) == '' ? 'class="sale-noti"' : null ?>>
                            <a href="<?= base_url() ?>">Anasayfa</a>
                        </li>

                        <li <?= $this->uri->segment(2) == 'erkek' ? 'class="sale-noti"' : null ?>>
                            <a href="<?= base_url('kategori/erkek') ?>">Erkek</a>
                        </li>

                        <li <?= $this->uri->segment(2) == 'kadin' ? 'class="sale-noti"' : null ?>>
                            <a href="<?= base_url('kategori/kadin') ?>">Kadın</a>
                        </li>

                        <li <?= $this->uri->segment(2) == 'cocuk' ? 'class="sale-noti"' : null ?>>
            ...
            <div class="header-icons">
                <a href="#" class="header-wrapicon1 dis-block">
                    <img src="<?= base_url('assets/front/') ?>images/icons/icon-header-01.png" class="header-icon1" alt="ICON">
                </a>
    ...
    <div class="wrap_header_mobile">
        ...
        <a href="index.html" class="logo-mobile">
            <img src="<?= base_url('assets/front/') ?>images/icons/logo.png" alt="IMG-LOGO">
        </a>
